...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 py-12 sm:py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass rounded-2xl p-6 sm:p-8 shadow-lg animate-slide-up">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">Join CampusStream today</p>
          </div>
